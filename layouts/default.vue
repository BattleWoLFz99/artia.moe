          ...
          <div style="vertical-align: middle;">
            ...
            <span>
              <a href="https://github.com/BattleWoLFz99" target="_blank" rel="noreferrer">
                {{ $t('site.footer.BattleWoLFz') }}
              </a>
            </span>
            <span>
              &
              <a href="https://space.bilibili.com/593654407" target="_blank" rel="noreferrer">
      ...
      nav_items: [
        {
          ...
          title: 'Twitch',
          to: 'https://www.twitch.tv/artia_hololive'
        },
        {
          icon: '/img/twitter-fill.svg',
          title: 'Twitter',
          to: 'https://twitter.com/Artia_OW'
        },
        {
          icon: '/img/bilibili-fill.svg',
          title: 'Bilibili',
          to: 'https://space.bilibili.com/511613155'
        }
      ],
      external_cn: [
        {
          icon: 'alpha_b_box',
          title: '赫卡Tia',
          to: 'https://space.bilibili.com/693/'
        }
      ]
    };
  },
